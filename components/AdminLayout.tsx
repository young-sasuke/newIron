...
// auth disabled: no supabase import
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const handleLogout = async () => {
    // Clear any access-token cookie used previously by middleware
    try {
      document.cookie = "sb-access-token=; Path=/; Max-Age=0; SameSite=Lax";
    } catch {}
    // Auth disabled: keep user in app; send to dashboard (or home) instead of login
